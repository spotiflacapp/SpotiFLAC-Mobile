...
import com.zarz.spotiflac.discord.DiscordDefaults.DISCORD_OAUTH_AUTHORIZE
import com.zarz.spotiflac.discord.DiscordDefaults.DISCORD_OAUTH_TOKEN
import com.zarz.spotiflac.discord.DiscordDefaults.DISCORD_SCOPES
...
class DiscordAuth(
    ...
    suspend fun authorize(activity: Activity): DiscordAuthResult {
        ...
        try {
            ...
            Timber.tag(TAG).i("authorize: launching URL (clientId prefix=%s)", "YOUR_DISCORD_CLIENT_ID".take(8))
    ...
    private suspend fun performTokenExchange(
        ...
        val response: HttpResponse = httpClient.submitForm(
            ...
            formParameters = parameters {
                append("client_id", "YOUR_DISCORD_CLIENT_ID")
    ...
    companion object {
        ...
        const val REDIRECT_URI = "spotiflacdiscord://oauth2/callback"
